##IMOPRTACION DE LAS VISTAS##
from .ambiente import RegistarAmbiente, ListarAmbientes, EliminarAmbiente, ActualizarAmbiente
...
from .ingreso import RegistrarIngreso, ListarIngresos, ActualizarIngreso
