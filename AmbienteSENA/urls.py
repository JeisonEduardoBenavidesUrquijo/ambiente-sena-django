...
from .Views import RegistarAmbiente, ListarAmbientes, EliminarAmbiente, ActualizarAmbiente
...
from .Views import RegistrarIngreso, ListarIngresos, ActualizarIngreso

urlpatterns = [
    path('', home),
    path('admin/', admin.site.urls),
    path('Ambientes/RegistrarAmbiente',RegistarAmbiente),
    ...
    path('Ingreso/ActualizarIngreso', ActualizarIngreso)
]